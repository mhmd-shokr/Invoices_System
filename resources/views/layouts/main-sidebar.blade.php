			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
						<h4 class="font-weight-semibold mt-3 mb-0">{{ optional(Auth::user())->name ?? 'زائر' }}</h4>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoice_paid') }}">قائمة الفواتير المدفوعة</a></li>
					@endcan
					@can( 'الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{route('invoice_unpaid') }}">قائمة الفواتير الغير مدفوعه</a></li>
					@endcan
					@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ route('invoice_partial') }}">قائمة الفواتير المدفوعه الجزئيه</a></li>
					@endcan
					@can( 'ارشيف الفواتير')
							<li><a class="slide-item" href="{{ route('invoices_archive.index') }}"> أرشيف الفواتير  </a></li>
					@endcan
