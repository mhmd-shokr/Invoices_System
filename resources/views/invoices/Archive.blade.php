        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form id="archiveForm" action="{{ route('invoices_archive.update', 'test') }}" method="post">
                    @method('patch')
                    @csrf
                </div>
                <div class="modal-body">
...
@section('js')
    ...
    <script>
        $('#delete_invoice').on('show.bs.modal', function(event) {
            ...
            //update action of form URL
            var action = "{{ url('invoices_archive') }}/" + invoice_id;
...
<script>
    $('#Transfer_invoice').on('show.bs.modal', function (event) {
        ...
        var invoice_id = button.data('invoice_id');
        var modal = $(this);
        // get value of id from hidden input
        modal.find('#invoice_id').val(invoice_id);
        
        let form = modal.find('#archiveForm');
        //update action of form URL
        let action = "{{ url('invoices_archive') }}/" + invoice_id;
        form.attr('action', action);
    });
</script>
